...
public class TileEntityFluidTank extends TileEntityContainerBlock implements IActiveState, IConfigurable, IFluidHandler, ISustainedTank, IFluidContainerManager, ITankManager, ISecurityTile
{
	...
	public void writeToNBT(NBTTagCompound nbtTags)
	{
		...
		nbtTags.setInteger("currentRedstoneLevel", currentRedstoneLevel);
	...
	public void readFromNBT(NBTTagCompound nbtTags)
	{
		...
		currentRedstoneLevel = nbtTags.getInteger("currentRedstoneLevel");
	...
	public int getRedstoneLevel()
	{
		...
		return MathHelper.floor_double(fractionFull*14) + (fractionFull > 0 ? 1 : 0);
	}
}
